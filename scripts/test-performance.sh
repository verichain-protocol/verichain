...
# Tests different batch sizes for streaming initialization performance
...
main() {
    ...
    echo "  2. Use the optimal batch size in deployments"
    echo "  3. Monitor cycles and memory usage"
    echo ""
}
...
case "${1:-}" in
    ...
    --help|-h)
        ...
        echo "to find the balance of speed and resource usage."
        ;;
    *)
        main
        ;;
